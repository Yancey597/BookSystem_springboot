...
public class SparkAIManager extends WebSocketListener {
    ...
    public static final String appid = "98e029e2";
    // todo 替换成你自己的 apiSecret 图书管理系统 1.1 版本
    public static final String apiSecret = "YmRlMGRhODE1MmU5Yzc4ZmU0Mzc0Yjg0";
    // todo 替换成你自己的 apiKey 图书管理系统 1.1 版本
    public static final String apiKey = "386caa019c220602cfe3826d048e6acf";
    ...
    public String sendMessageAndGetResponse(String message, Integer sleepTime) throws Exception {
        ...
        while (true) {
            if (totalFlag) {
                ...
                for (int i = 0; i < 1; i++) {
                    totalAnswer = "";
                    WebSocket webSocket = client.newWebSocket(request, new SparkAIManager(String.valueOf(i),
                            false));
                }
            } else {
